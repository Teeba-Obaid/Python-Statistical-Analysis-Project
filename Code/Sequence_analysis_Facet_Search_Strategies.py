...
clusters = {
    1: "NAN',PCS,PVDS,CCV,CVDV,NO,RCCR,RVDCR,PtVDN,PtCN",
    2: "TPN,PCS,PVDS,CCF,CVDV,NO,RCR,RVDSS,PCS,PVDF,CCV,CVDV,RCSS,RVDR,PtVDP,PtCP",
    3: "TPN,PCS,PVDF,CCV,CVDV,NO,RCSS,RVDR,PCS,PVDS,CCV,CVDV,RCCR,RVDCR,PCF,PVDS,CCF,CVDV,RCR,RVDSS,PCS,PVDS,CCV,CVDV,RCM,RVDSS,PCS,PVDS,CCV,CVDV,RCCR,RVDCR,PtVDP,PtCV1",
    4: "TPN,PCF,PVDS,CCV,CVDV,PG,RCR,RVDSS,PCS,PVDS,CCV,CVDV,RCCR,RVDSS,PCF,PVDF,CCV,CVDF,RCR,RVDR,PCS,PVDS,CCV,CVDV,RCO,RVDSS,PtVDP,PtCV2",
    5: "TPN,PCS,PVDF,CCV,CVDF,PG,RCSS,RVDR,PCS,PVDS,CCV,CVDV,RCR,RVDO,PCF,PVDF,CCF,CVDV,RCO,RVDO,PtVDV2,PtCV2"
}
...
chart1 = alt.Chart(df[df['cluster'] == 'Cluster 1']).mark_point(filled=True, size=200).encode(
    ...
    color=alt.Color('cluster:N',scale=color_palette, legend=None),
    shape=alt.Shape('cluster:N',scale=shape_palette, legend=None),
...
combined_chart = alt.vconcat(
    ...
    title={
      ...
      "subtitle": 'Clusters Across Control Group, Decision Table Plus Rule Induction Group, and Rule Induction Group',
      "color": "black",
      "subtitleColor": "gray",
      "anchor": "middle",
      "subtitlePadding": 5,
