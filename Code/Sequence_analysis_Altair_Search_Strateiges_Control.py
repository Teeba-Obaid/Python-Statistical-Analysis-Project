...
clusters = {
    ...
    2: "TPN,PCS,PVDS,CCV,CVDV,NO,RCCR,NO,PCS,PVDF,CCV,CVDV,NO,RVDR,PtVDP,PtCN"
}
...
color_palette = alt.Scale(domain=['Cluster 1', 'Cluster 2'],
                          range=['#1f77b4', '#4eac01'])

# Define the shape palette
shape_palette = alt.Scale(domain=['Cluster 1', 'Cluster 2'],
                          range=['circle', 'cross'])
...
combined_chart = alt.vconcat(
    alt.hconcat(chart1, chart2)).resolve_scale(y='shared').properties(
    title={
      "text": 'K-Means Clustering of Search Strategies: Median String Sequences',
      "subtitle": 'Clusters Across Control Group',
      "color": "black",
      "subtitleColor": "gray",
      "anchor": "middle",
      "subtitlePadding": 5,
