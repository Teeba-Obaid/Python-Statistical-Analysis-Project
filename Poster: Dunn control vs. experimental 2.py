...
chart = alt.Chart(df).mark_circle().encode(
    ...
    title={
        "text": ['P-values from Dunn\'s test between Control Group vs. Experimental Group for Different Variables'],
...
chart = chart.configure_legend(
    titleFontSize=16,  # Increase the legend title font size for 'Magnitude of Correlation' and 'Effect Size'
    labelFontSize=18  # Increase the legend label font size
)
