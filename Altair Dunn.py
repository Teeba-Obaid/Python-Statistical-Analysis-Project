...
chart = alt.Chart(df).mark_circle().encode(
    x=alt.X('Variable:N', title='Variable Name', sort=dependent_variables, axis=alt.Axis(labelAngle=-90, labelFontSize=10, labelLimit=800, grid=True)),
    ...
    title='P-values from Dunn\'s test between Groups for Different Variables',
