...
clusters = {
    1: "TPN,PCF,PVDS,CCF,CVDV,NO,RCR,RVDSS,PCS,PVDF,CCV,CVDF,RCSS,RVDR,PtVDP,PtCP",
    2: "TPN,PCS,PVDS,CCV,CVDV,NO,RCSS,RVDSS,PCF,PVDF,CCV,CVDF,RCR,RVDR,PCS,PVDS,CCV,CVDV,RCCR,RVDCR,PCF,PVDS,CCV,CVDV,RCR,RVDSS,PtVDP,PtCV1",
    3: "TPN,PCF,PVDS,CCV,CVDV,PG,RCR,RVDSS,PCS,PVDF,CCV,CVDV,RCSS,RVDR,PCS,PVDF,CCV,CVDF,RCSS,RVDO,PtVDV2,PtCP",
}
...
combined_chart = alt.vconcat(
    ...
    title={
      ...
      "subtitle": 'Clusters Across Experimental Group 2',
      "color": "black",
      "subtitleColor": "gray",
      "anchor": "middle",
      "subtitlePadding": 5,
